...
[] implement the project with React Native(this will be fun)

Each item in the list will have 3 properties: label(emoji), text, checkbox. The label will be automatically generated, but can be changed immediately after with any emoji of choice(will need to use some kind of api for this). After each day all habits go to an "unchecked" state. Lesgo
